...
public class LOLParser {
	...
	public static Time getStartTime(String input) {
		...
		// Check from 2nd element onwards
		for (int i = 1; i < detailsArray.length; i++) {
			if (is12hrTime(detailsArray[i])) {
				return create12hrTime(detailsArray[i]);
			} else if (is24hrTime(detailsArray[i])) {
				return new Time(detailsArray[i]);
			} else if (isTimeRange(detailsArray[i])) {
				return createStartTimeFromRange(detailsArray[i]);
			}
		}
		return null;
	}
	 ...
	 * @return Time object
	 */
	public static Time create12hrTime(String string) {
		string = string.trim();
	 ...
	 */
	public static Time createStartTimeFromRange(String string) {
		string = string.trim();
	 ...
	 */
	public static boolean is12hrTime(String string) {
		string = string.trim();
	 ...
	 */
	public static boolean is24hrTime(String string) {
		string = string.trim();
		if (string.length() != 4) {
			return false;
		}
	 ...
	 */
	public static boolean isTimeRange(String string) {
		if (string.contains(" to ")) {
			String[] times = string.split(" to ");
	 ...
	 */
	public static boolean isTimeWithoutAmpm(String string) {
		string = string.trim();
	 ...
	 */
	public static boolean isHourInRange(String hourStr) {
	 ...
	 */
	public static boolean isMinuteInRange(String minuteStr) {
