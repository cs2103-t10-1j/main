...
public class Date {
	...
	public Date(int day, int month, int year, Time time) { // e.g 2.3.14 5am or 2.3.2014 5am
		setDay(day);
		setMonth(month);
	...
	public boolean equals(Object obj) {
		if (obj instanceof Date) {
			Date other = (Date)obj;
			return other.getDay() == this.getDay() && other.getMonth() == this.getMonth() && other.getYear4Digit() == this.getYear4Digit() && other.getTime().equals(this.getTime());
		} else {
			return false;
		}
	}
		...
		if (this.getYear4Digit() < other.getYear4Digit()) { // year is smaller
			...
			if (this.getMonth() < other.getMonth()) {  // month is smaller
				...
				if (this.getDay() < other.getDay()) {  // day is smaller
					...
					if (this.getTime().isBefore(other.getTime())) {  // time is smaller
						return true;
	 ...
	 * @param year  2-digit or 4-digit year
	 * @return      4-digit year
	 */
