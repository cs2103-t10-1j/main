...
<<<<<<< HEAD
		...
		assertEquals(new Task("camp", "island", new Date(24, 11, 2014), new Date(2, 12, 2015)), LOLParser.getTask("add camp at island from 24/11 to 2 dec"));
...
=======
		 ...
		 */
>>>>>>> 78c0e7ffd7b2c0ef8cc111939dbf1e53a7d71578
		/*
